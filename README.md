...
- **Chess-based**: The trainer/king is on the battlefield. If they faint its is game over.
...
## Gameplay of the Second Prototype
...
In the case of the trainer, their avaiable attack is to summon one mounster of their team. They select a mounster and where to spawn them.
